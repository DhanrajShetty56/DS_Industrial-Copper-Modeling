...
with tab1:    
        ...
        if submit_button and flag==0:
            ...
            import pickle
            with open(r"Copper_model\model.pkl", 'rb') as file:
                loaded_model = pickle.load(file)
            with open(r'Copper_model\scaler.pkl', 'rb') as f:
                scaler_loaded = pickle.load(f)

            with open(r"Copper_model\t.pkl", 'rb') as f:
                t_loaded = pickle.load(f)

            with open(r"Copper_model\s.pkl", 'rb') as f:
...
with tab2: 
        ...
        if csubmit_button and cflag==0:
            import pickle
            with open(r"Copper_model\cmodel.pkl", 'rb') as file:
                cloaded_model = pickle.load(file)

            with open(r'Copper_model\cscaler.pkl', 'rb') as f:
                cscaler_loaded = pickle.load(f)

            with open(r"Copper_model\ct.pkl", 'rb') as f:
...
st.write( f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by Dhanraj</h6>', unsafe_allow_html=True )  